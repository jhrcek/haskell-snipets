import Data.Time.Clock (secondsToDiffTime, picosecondsToDiffTime, DiffTime, UTCTime)
...
t5 :: POSIXTime
t5 = fromIntegral 10 :: POSIXTime --10 sec after EPOCH (1.1.1970)
